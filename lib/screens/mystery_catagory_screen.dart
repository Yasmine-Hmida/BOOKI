...
class MysteryCategoryScreen extends StatefulWidget {
  const MysteryCategoryScreen({Key? key}) : super(key: key);

  @override
  State<MysteryCategoryScreen> createState() => _MysteryCategoryScreenState();
}

class _MysteryCategoryScreenState extends State<MysteryCategoryScreen>
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Search for your fav mystery Books...',
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/images/misteryHeaderImage.jpeg'),
          fit: BoxFit.cover,
  ...
  Widget _buildMysteryBooksSection() {
    final mysteryBooks = [
      {
    ...
    return Container(
      ...
      child: Column(
        children: mysteryBooks.map((book) {
