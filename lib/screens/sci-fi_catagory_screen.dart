...
class SciFiCategoryScreen extends StatefulWidget {
  ...
  @override
  State<SciFiCategoryScreen> createState() => _SciFiCategoryScreenState();
}

class _SciFiCategoryScreenState extends State<SciFiCategoryScreen>
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Search for your fav sci-fi Books...',
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/images/sciFiHeaderImage.png'),
          fit: BoxFit.cover,
